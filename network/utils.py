...
class _Segmentation(nn.Module):
    ...
    def forward(self, inp,mu_t_f1=0, std_t_f1=0, transfer=False,mix=False,activation=None):
        
        # breakpoint()
        # breakpoint()
        features = {}
        features['low_level'] = self.backbone(inp,trunc1=False,trunc2=False,
        ...
        x = self.classifier(features['out']) ######changed for classification######
        # breakpoint()
