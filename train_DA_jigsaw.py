        ...
        with torch.no_grad():
            for phase, loader in self.test_loaders.items():
                ...
                if phase=="test":
                    ...
                    print("epoch no: ", min_idx, " Phase: ", phase, " jigsaw ", min_loss, " class ", test_acc_list[min_idx])
                    logger.info("epoch no: ", min_idx, " Phase: ", phase, " jigsaw ", min_loss, " class ", test_acc_list[min_idx])
